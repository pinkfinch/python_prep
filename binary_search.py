...
print( binary_search([1,3,4,5,6,7,8,10,11,13,15,17,20,22], 17))
print( binary_search([1,3,4,5,6,7,8,10,11,13,15,17,20,22], 12))
print( binary_search([1,3,4,5,6,7,8,10,11,13,15,17,20,22], -1))
print( binary_search([1,3,4,5,6,7,8,10,11,13,15,17,20,22], 25))
